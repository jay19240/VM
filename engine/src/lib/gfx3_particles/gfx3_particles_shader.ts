/** Points d'insertion personnalisables des shaders de particules. */
export const PARTICLES_SHADER_INSERTS = {
  VERT_INSERT: '',
  FRAG_INSERT: ''
};

/** Nombre de composantes scalaires contenues dans un sommet de particule. */
export const PARTICLES_SHADER_VERTEX_ATTR_COUNT = 15;

/** Descripteur de la pipeline de rendu des particules. */
...
/**
 * Génère le shader de sommets des particules.
 *
...
/**
 * Génère le shader de fragments des particules.
 *
 * @param data - Code WGSL à injecter dans le gabarit.
