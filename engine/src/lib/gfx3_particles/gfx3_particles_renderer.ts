...
/**
 * Rend les systèmes de particules mis en file d'attente au moyen d'une instance partagée.
 */
export class Gfx3ParticlesRenderer extends Gfx3RendererAbstract {
  ...
  /** Initialise la pipeline et les groupes de liaison du moteur de rendu des particules. */
  constructor() {
  ...
  /**
   * Rend les systèmes de particules en attente, puis vide la file.
   *
  ...
  /**
   * Ajoute un système de particules à la prochaine passe de rendu.
   *
   * @param particles - Système de particules à dessiner.
   */
...
/** Instance partagée du moteur de rendu des particules. */
