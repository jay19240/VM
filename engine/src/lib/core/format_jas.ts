/**
 * Décrit une feuille de sprites au format JAS.
 */
...
/**
 * Décrit une animation nommée d'une feuille de sprites JAS.
 */
...
/**
 * Décrit le rectangle d'une image d'animation dans la texture source.
 */
...
/**
 * Recherche une animation par son nom.
 *
 * @param jas - Données de la feuille de sprites.
 * @param name - Nom de l'animation recherchée.
 * @returns Animation correspondante.
 * @throws Une erreur si l'animation n'existe pas.
 */
...
/**
 * Retourne une image précise d'une animation.
 *
 * @param jas - Données de la feuille de sprites.
 * @param name - Nom de l'animation.
 * @param frameIndex - Indice de l'image à retourner.
 * @returns Rectangle de l'image demandée.
 * @throws Une erreur si l'animation n'existe pas.
 */
...
/**
 * Convertit un fichier JSON EZ Sprite Sheet au format JAS.
 *
 * @param path - Chemin du fichier source.
 * @returns Feuille de sprites convertie.
 */
...
/**
 * Convertit une exportation JSON Aseprite au format JAS.
 *
 * @param path - Chemin du fichier source.
 * @returns Feuille de sprites dont les animations correspondent aux balises Aseprite.
 */
