...
/**
 * Regroupe des tests statiques d'intersection pour des primitives 2D et 3D.
 */
export class PH {
  // ------------------------------------------------------------------------------------
  // BOX
  ...
  /**
   * Teste l'intersection de deux boîtes alignées sur les axes.
   *
   * @param min1 - Coin minimal de la première boîte.
   * @param max1 - Coin maximal de la première boîte.
   * @param min2 - Coin minimal de la seconde boîte.
   * @param max2 - Coin maximal de la seconde boîte.
   * @returns `true` si les boîtes se chevauchent ou se touchent.
   */
  ...
  /**
   * Teste si un point appartient à une boîte alignée sur les axes.
   *
   * @param min - Coin minimal de la boîte.
   * @param max - Coin maximal de la boîte.
   * @param p - Point à tester.
   * @returns `true` si le point se trouve dans la boîte ou sur sa surface.
   */
  ...
  /**
   * Teste l'intersection d'une boîte alignée sur les axes et d'un cylindre vertical.
   *
   * @param min - Coin minimal de la boîte.
   * @param max - Coin maximal de la boîte.
   * @param c - Centre de la base du cylindre.
   * @param r - Rayon du cylindre.
   * @param h - Hauteur du cylindre.
   * @returns `true` si les volumes se chevauchent ou se touchent.
   */
  ...
  /**
   * Teste l'intersection de deux cylindres verticaux.
   *
   * @param c1 - Centre de la base du premier cylindre.
   * @param r1 - Rayon du premier cylindre.
   * @param h1 - Hauteur du premier cylindre.
   * @param c2 - Centre de la base du second cylindre.
   * @param r2 - Rayon du second cylindre.
   * @param h2 - Hauteur du second cylindre.
   * @param outVelocity - Vecteur recevant la correction de pénétration horizontale.
   * @returns `true` si les cylindres se chevauchent ou se touchent.
   */
  ...
  /**
   * Teste si un point appartient à un cylindre vertical.
   *
   * @param c - Centre de la base du cylindre.
   * @param h - Hauteur du cylindre.
   * @param r - Rayon du cylindre.
   * @param p - Point à tester.
   * @returns `true` si le point se trouve dans le cylindre ou sur sa surface.
   */
  ...
  /**
   * Teste l'intersection d'un cylindre vertical et d'une boîte alignée sur les axes.
   *
   * @param c - Centre de la base du cylindre.
   * @param r - Rayon du cylindre.
   * @param h - Hauteur du cylindre.
  ...
  /**
   * Calcule la normale non normalisée d'un triangle 3D.
   *
   * @param a - Premier sommet.
   * @param b - Deuxième sommet.
   * @param c - Troisième sommet.
   * @param out - Vecteur de destination.
   * @returns Normale du triangle.
   */
  ...
  /**
   * Teste si un point coplanaire appartient à un triangle 3D par coordonnées barycentriques.
   *
   * @param p - Point à tester.
   * @param a - Premier sommet.
   * @param b - Deuxième sommet.
   * @param c - Troisième sommet.
   * @returns `true` si le point se trouve à l'intérieur du triangle.
   */
  ...
  /**
   * Calcule l'altitude d'un triangle 3D à une position horizontale donnée.
   *
   * @param p - Position dans le plan XZ.
   * @param a - Premier sommet du triangle.
   * @param b - Deuxième sommet du triangle.
   * @param c - Troisième sommet du triangle.
   * @returns Altitude interpolée, ou `Infinity` si la position est hors du triangle.
   */
  ...
  /**
   * Teste l'intersection d'un rayon et d'un triangle 3D.
   *
   ...
   * @param b - Deuxième sommet du triangle.
   * @param c - Troisième sommet du triangle.
   * @param culling - Indique s'il faut ignorer les faces orientées dans le sens du rayon.
   * @param outIntersectPoint - Vecteur recevant le point d'intersection.
   * @returns `true` si le rayon rencontre le triangle.
   */
  ...
  /**
   * Teste l'intersection d'un rayon et d'un plan 3D.
   *
   * @param origin - Origine du rayon.
   * @param dir - Direction du rayon.
   * @param a - Point appartenant au plan.
   * @param n - Normale du plan.
   * @param culling - Indique s'il faut ignorer les plans orientés dans le sens du rayon.
   * @param outIntersectPoint - Vecteur recevant le point d'intersection.
   * @returns `true` si l'intersection se situe devant l'origine du rayon.
   */
  ...
  /**
   * Teste l'intersection d'un rayon et d'une boîte alignée sur les axes.
   *
   * @param origin - Origine du rayon.
   * @param dir - Direction du rayon.
   * @param min - Coin minimal de la boîte.
   * @param max - Coin maximal de la boîte.
   * @param outIntersectPoint - Vecteur recevant le point d'intersection.
   * @returns `true` si le rayon rencontre une face de la boîte.
   */
  ...
  /**
   * Teste l'intersection de deux rectangles alignés sur les axes.
   *
   * @param min1 - Coin minimal du premier rectangle.
   * @param max1 - Coin maximal du premier rectangle.
   * @param min2 - Coin minimal du second rectangle.
   * @param max2 - Coin maximal du second rectangle.
   * @returns `true` si les rectangles se chevauchent ou se touchent.
   */
  ...
  /**
   * Teste si un point appartient à un rectangle aligné sur les axes.
   *
   * @param min - Coin minimal du rectangle.
   * @param max - Coin maximal du rectangle.
   * @param p - Point à tester.
   * @returns `true` si le point se trouve dans le rectangle ou sur son contour.
   */
  ...
  /**
   * Teste l'intersection d'un rectangle aligné sur les axes et d'un cercle.
   *
   * @param min - Coin minimal du rectangle.
   * @param max - Coin maximal du rectangle.
   * @param c - Centre du cercle.
   * @param r - Rayon du cercle.
   * @returns `true` si les formes se chevauchent ou se touchent.
   */
  ...
  /**
   * Teste l'intersection de deux cercles.
   *
   * @param c1 - Centre du premier cercle.
   * @param r1 - Rayon du premier cercle.
   * @param c2 - Centre du second cercle.
   * @param r2 - Rayon du second cercle.
   * @param outVelocity - Vecteur recevant la correction de pénétration.
   * @returns `true` si les cercles se chevauchent ou se touchent.
   */
   ...
   * @param r - Rayon du cercle.
   * @param p - Point à tester.
   * @returns `true` si le point se trouve dans le cercle ou sur son contour.
   */
  ...
  /**
   * Teste l'intersection d'un cercle et d'un rectangle aligné sur les axes.
   *
   * @param c - Centre du cercle.
   * @param r - Rayon du cercle.
   * @param min - Coin minimal du rectangle.
  ...
  /**
   * Teste l'intersection de deux segments 2D.
   *
   * @param p1 - Début du premier segment.
   * @param q1 - Fin du premier segment.
   * @param p2 - Début du second segment.
   * @param q2 - Fin du second segment.
   * @returns `true` si les segments se croisent.
   */
  ...
  /**
   * Construit les quatre segments qui délimitent un rectangle.
   *
   * @param l - Coordonnée du côté gauche.
   * @param t - Coordonnée du côté supérieur.
   * @param r - Coordonnée du côté droit.
   * @param b - Coordonnée du côté inférieur.
   * @returns Segments gauche, supérieur, droit et inférieur.
   */
  ...
  /**
   * Classe un point par rapport aux trois arêtes orientées d'un triangle 2D.
   *
   * @param p - Point à tester.
   * @param a - Premier sommet du triangle.
   * @param b - Deuxième sommet du triangle.
   * @param c - Troisième sommet du triangle.
   * @returns `1` si le point est à l'intérieur, sinon `-1`, `-2` ou `-3` selon l'arête franchie.
   */
