/** Nombre de composantes scalaires par sommet d'un halo. */
export const FLARE_SHADER_VERTEX_ATTR_COUNT = 4;

/** Descripteur de la pipeline WebGPU utilisée pour rendre les halos. */
...
/**
 * Génère le code WGSL du shader de sommets des halos.
 *
...
/**
 * Génère le code WGSL du shader de fragments des halos.
 *
 * @param data - Données de personnalisation de la pipeline, actuellement inutilisées.
