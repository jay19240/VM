...
/**
 * Moteur de rendu singleton pour les éléments 2D superposés à la scène.
 * Il convient aux halos optiques, à la pluie, à la neige et aux autres effets dans le plan de l'écran.
 * Le coin supérieur gauche de l'écran correspond aux coordonnées `(0, 0)`.
 */
export class Gfx3FlareRenderer extends Gfx3RendererAbstract {
  ...
  /** Initialise la pipeline des halos et les groupes de liaison statique et dynamique. */
  constructor() {
  ...
  /**
   * Rend tous les halos mis en file, puis vide la file de rendu.
   *
   * @param destinationTexture - Texture cible facultative ; la passe courante est utilisée lorsqu'elle vaut `null`.
   */
  ...
  /**
   * Ajoute un halo à la file de la prochaine passe de rendu.
   *
   * @param flare - Halo à rendre.
   */
...
/** Instance partagée du moteur de rendu des halos. */
